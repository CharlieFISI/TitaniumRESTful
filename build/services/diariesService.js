...
exports.addDiary = exports.getEntriesWithoutSensivityInfo = exports.findById = exports.getEntries = void 0;
...
const getEntriesWithoutSensivityInfo = () => diaries.map(({ id, date, weather, visibility }) => ({
    id,
    date,
    weather,
    visibility
